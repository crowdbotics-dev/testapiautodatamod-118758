...
## Project Structure
    ...
    ├── testapiautodatamod_118758  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_118758`
...
2. Clone this repo and `cd testapiautodatamod_118758`
